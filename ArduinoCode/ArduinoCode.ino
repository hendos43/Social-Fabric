...
void loop()
{
  ...
  sendFloat(2, smooth(A0));
  sendFloat(3, smooth(A1));
  sendFloat(4, smooth(A2));

  //remap A3 to take 0-1023 -> -180-180
  //float angle = map(analogRead(A3), 0, 1023, -1, 1);
  float angle = smooth(A3);
  sendFloat(5, angle);
